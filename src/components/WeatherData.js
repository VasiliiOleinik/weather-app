...
export default function WeatherData() {
  ...
  return (
    <div className="card text-center">
      <audio src={sound} autoPlay={true}></audio>
      <div className="card-header">
        <h2>Weather in <strong className="text-info">{weather.city}</strong></h2>
      </div>
      <div className="card-body">
        <img src={`https://openweathermap.org/img/wn/${weather.iconID}@2x.png`} alt={weather.main}/>
        <p>
          <span className="card-title"><strong>Main:</strong> </span>
          <span className="card-text text-warning">{weather.main}</span>
        </p>
        <p>
          <span className="card-title"><strong>Temperature:</strong> </span>
          <span className="card-text text-warning">{weather.mainTemp}</span>
        </p>
        <p>
          <span className="card-title"><strong>Feels Like:</strong> </span>
          <span className="card-text text-warning">{weather.feelsLike}</span>
        </p>
        <p>
          <span className="card-title"><strong>Description:</strong> </span>
